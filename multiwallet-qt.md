...
In order to support loading of multiple wallets in iotcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is iotcoin.cpp.
...
Changes to iotcoin.cpp
----------------------
iotcoin.cpp is the entry point into iotcoin-qt, and as such, will require some minor modifications to provide hooks for
